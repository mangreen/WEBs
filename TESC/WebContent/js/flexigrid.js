 ...
 * modified my meade for single row select and selectid中文
 */
...
(function($){
	...
	$.addFlex = function(t,p)
	{
		...
		p = $.extend({
             ...
             onRowSelected: false, //added to allow row select option
             multiSelect: false,   //added for single row select
             selectid: -1, //added to help select result set
             action: '',
             recid: '' //added to help select result set
		  }, p);
		...
		var g = {
			...
			populate: function () { //get latest data
				...
				var param = {action:p.action, page:p.newp, selectid:p.selectid, recid:p.recid, rp: p.rp, sortname: p.sortname, sortorder: p.sortorder, query: p.query, qtype: p.qtype};
