		...
		$(document).ready(function() {
			...
			var validator = $("#modifyform").validate({
				...
				submitHandler: function() {
					$.ajax({ 				
		                 type:"POST",  
		                 url:"/TESC/login.do?action=modifyaccount",  
			...
			function modifyseccess(){
				if(nextaction="qeii_1"){
					$("#tabs-2").load("view/qeii/qeii_form.jsp",{account:'jimmy'},function(){
						$("#tabs-2").fadeIn('slow');}
					);
				...
				<div class="content">
					<div id="modifybox">
					  ...
					  <div id="modifywrap">
							...
							<input type="hidden" value="modifyaccount" name="action" ></input>
								...
								<tr>
									<td colspan="2" style="width: 80%" ><table style="width: 100%" cellspacing="0" cellpadding="0" class="table_3border">
										...
										<tr>
											...
											<td class="inlist3" style="width: 550px"><input id="account" name="account" type="text" value="${user.account}" maxlength="50" class="input"></th></td>
										...
										<tr>
											...
											<td class="inlist3"><input id="email" name="email" type="text" value="${user.email}" maxlength="150" class="input"></th></td>
											<td class="inlist" align="left"></td>
										</tr>
