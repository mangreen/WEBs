...
import edu.ntnu.tesc.module.viewmodule.DepartmentTableListModule;

public class GetDepartTableCommand implements ICommand {
	...
	public IModelView execute() {
		...
		if(selectid==null|| selectid.equals("null") || selectid.equals("-1")){
			...
			DepartmentTableListModule tablelistmodule = new DepartmentTableListModule();
