...
import edu.ntnu.tesc.module.viewmodule.PrivilegeTableListModule;


public class GetPrivTableCommand implements ICommand {
	...
	public IModelView execute() {
		...
		if(selectid==null|| selectid.equals("null") || selectid.equals("-1")){
			...
			List<Privilege> list = privlegeDAO.getPrivilegeList();
			
			PrivilegeTableListModule tablelistmodule = new PrivilegeTableListModule();
