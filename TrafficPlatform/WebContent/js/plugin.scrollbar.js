...
(function($) {
	$.fn.scrollbar = function(params) {
		...
		params = $.extend( {
			...
			marge_scroll_contenu: 20,		//Marge entre la scrollBar et le contenu - /!\ Doit �tre un nombre
			largeur_scrollbar:2				//Largeur de la scrollbar
		}, params);
		...
		return this.each(function() {
			...
			function calcul_hauteur_auto(){
				if(params.taille_englobe == "auto"){
					...
					params.taille_englobe = $('#center').height()-145-padBot-padTop;
			...
			if(controle_donnee()){
				...
				$$.find('.englobe').css({'top':0+'px','float':'left','position':'relative','width':temp+'px'});	
